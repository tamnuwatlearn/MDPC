proc insert_delay_implementation {{delay_element "delay_req"} {net_in "d"} {net_out "z"} {loc "SLICE_X13Y17/D6LUT"}} {
	...
	place_cell "${base_path}/${delay_name}${num_inserted_delay}" "${loc}"
	
}

#insert_delay_loc "delay_req" "d" "z" "SLICE_X13Y17"
